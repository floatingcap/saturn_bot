...
- **Guild & Channel IDs** – used for server-specific settings.
- **Messages** – only processed when you use a command. Not stored unless the feature needs it.

## 2. What We Don’t Collect
- No passwords, emails, or sensitive stuff.
- No fingerprinting, tracking, or ads.
- No DMs are read unless you message fybot directly.

## 3. Data Storage & Deletion
- If any data is saved, it's kept securely on the bot’s host (like Replit).
